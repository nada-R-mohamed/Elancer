                        ...
                        @foreach ($projects as $project)
                            <li>
                                    ...
                                    <div class="job-listing-details">
                                        ...
                                        <div class="job-listing-description">
                                            <h3 class="job-listing-title"><a href="#">{{ $project->title }}</a>
                                                <span class="dashboard-status-button yellow">{{ $project->status }}</span>
                                            </h3>
                                ...
                                <div class="buttons-to-right always-visible">
                                    ...
                                    <a href="{{ route('client.projects.edit',$project->id) }}" class="button gray ripple-effect ico" title="Edit"
